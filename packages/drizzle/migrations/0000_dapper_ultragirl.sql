...
CREATE TABLE "artifact_offer_likes" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"offerId" uuid NOT NULL,
	"userId" uuid NOT NULL,
...
ALTER TABLE "artifact_offer_likes" ADD CONSTRAINT "artifact_offer_likes_offerId_artifact_offers_id_fk" FOREIGN KEY ("offerId") REFERENCES "public"."artifact_offers"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "artifact_offer_likes" ADD CONSTRAINT "artifact_offer_likes_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "unique_like_per_user_offer" ON "artifact_offer_likes" USING btree ("offerId","userId");--> statement-breakpoint
